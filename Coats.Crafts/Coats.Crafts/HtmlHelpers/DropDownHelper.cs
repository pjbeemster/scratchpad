...
namespace Coats.Crafts.HtmlHelpers
{
    ...
    public static class HtmlHelpers
    {
        ...
        {
            object o = null;
            IEnumerable<GroupedSelectListItem> selectList = null;
            ...
            if (o != null)
            {
                selectList = o as IEnumerable<GroupedSelectListItem>;
            }
            ...
            try
            {
                ...
                if (!String.IsNullOrEmpty(name))
                {
                    ...
                    foreach (var group in selectList.GroupBy(i => i.GroupKey))
                    {
                        ...
                        if (group.Count() > 1)
                        {
                            listItemBuilder.AppendLine(string.Format("<optgroup label=\"{0}\" value=\"{1}\">", groupName,
                                                                group.Key));
